...
p_ANA = p_ANA'
CSV.write("Burggraf_u_num_steady.csv", DataFrame(u_num, :auto))
CSV.write("Burggraf_v_num_steady.csv", DataFrame(v_num, :auto))
CSV.write("Burggraf_velocity_num_steady.csv", DataFrame(velocity_num, :auto))
CSV.write("Burggraf_p_num_steady.csv", DataFrame(p_num, :auto))
